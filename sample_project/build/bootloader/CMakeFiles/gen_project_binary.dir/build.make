...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/jachin/esp/projects/has/sample_project/build/bootloader/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	python /home/jachin/esp/esp-idf/components/esptool_py/esptool/esptool.py --chip esp32 elf2image --flash_mode dio --flash_freq 40m --flash_size 4MB -o /home/jachin/esp/projects/has/sample_project/build/bootloader/bootloader.bin /home/jachin/esp/projects/has/sample_project/build/bootloader/bootloader.elf
	/usr/bin/cmake -E echo "Generated /home/jachin/esp/projects/has/sample_project/build/bootloader/bootloader.bin"
	/usr/bin/cmake -E md5sum /home/jachin/esp/projects/has/sample_project/build/bootloader/bootloader.bin > /home/jachin/esp/projects/has/sample_project/build/bootloader/.bin_timestamp
